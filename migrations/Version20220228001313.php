 ...
 */
final class Version20220228001313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meeting (id INT NOT NULL, attendee_id INT NOT NULL, status VARCHAR(10) NOT NULL, duration INT NOT NULL, time_slot TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
